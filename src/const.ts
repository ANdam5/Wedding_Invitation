 ...
 */
export const WEDDING_DATE_FORMAT = `2027년 1월 30일 토요일 오후 2시${WEDDING_DATE.minute() === 0 ? "" : " 30분"}`
 ...
 * 예식 장소 상세 주소
 */
export const LOCATION_ADDRESS = "서울특별시 용산구 용산동3가 이태원로 22"
 ...
 */
export const WEDDING_HALL_POSITION = [126.9777, 37.5336]

/**
 * 네이버 지도 장소 ID (NMAP_PLACE_ID)
 * 네이버 지도에서 장소 검색 후 URL의 숫자 부분을 입력합니다.
 */
export const NMAP_PLACE_ID = 13353325
